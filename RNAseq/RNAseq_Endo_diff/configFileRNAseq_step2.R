...
samplesPlan <- file.path(gitHubDir, "RNAseq/RNAseq_Endo_diff/samplesPlan_HoxLess_Endo.txt")



#### STEP 2 - DESEQ 2 ANALYSIS ###
#Required
tableWithCounts <- file.path(gitHubDir, "outputs/RNAseq/RNAseq_Endo_diff/AllHTSeqCounts.txt.gz")
...
# Optional
tableWithAnnotations <- file.path(gitHubDir, "outputs/RNAseq/RNAseq_Endo_diff/AllCufflinks_Simplified.txt.gz") # This can be table from cufflinks or cuffdiff or Biomart to annotate genes. You will need to choose a file with at least one column with the Ensembl Gene IDs.
...
outputDESeqTable <- file.path(gitHubDir, "outputs/RNAseq/RNAseq_Endo_diff/DESeq2AnalysisForFactorLine.txt")
