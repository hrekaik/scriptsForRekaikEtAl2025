...
samplesPlan<-file.path(gitHubDir,"samplesPlan_ActAvsChiron_wtonly_all.txt") #This file should be a tabulated file with at least one column called "sample". Optionnaly, the paths to the counts tables and FPKM tables can be provided under the column called: htseq_count_file and cufflinks_file.


#### STEP 1 - MERGE TABLES ### 
#If the merged tables are not already generated:
outputFolderForStep1<-file.path(gitHubDir, "../../../outputs/RNAseq/RNAseq_ActA/ActAvsChrion")
#Needed for DESeq2:
