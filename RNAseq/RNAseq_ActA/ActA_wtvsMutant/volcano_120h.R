...
deseq2.res <- read.delim(file.path(gitHubDir, "../../../outputs/RNAseq/RNAseq_ActA/ActA_wtvsMutant/DESeq2Analysis_120h.txt"))
...
ggplot(deseq2.res, aes(x = log2FoldChange, y = -log10(padj))) +
  ...
  theme_classic()
ggsave("../../../outputs/RNAseq/RNAseq_ActA/ActA_wtvsMutant/Volcano_selectedgenes_120h.pdf", width = 7, height = 7)
