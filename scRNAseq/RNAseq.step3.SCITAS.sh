...
#SBATCH --mem=80G
#SBATCH -o scriptsForRekaikEtAl2025/scRNAseq/RNAseq.Step3.out
#SBATCH -e scriptsForRekaikEtAl2025/scRNAseq/RNAseq.Step3.err
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --mail-user=lucille.delisle@epfl.ch
#SBATCH --job-name RNAseq.Step3
...
singularity exec --cleanenv $SIF \
    Rscript $PWD/scriptsForRekaikEtAl2025/scRNAseq/RNAseq.Step3.forFigures.R
