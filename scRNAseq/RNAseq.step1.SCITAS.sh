...
#SBATCH --mem=80G
#SBATCH -o scriptsForRekaikEtAl2025/scRNAseq/RNAseq.Step1.out
#SBATCH -e scriptsForRekaikEtAl2025/scRNAseq/RNAseq.Step1.err
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --mail-user=lucille.delisle@epfl.ch
#SBATCH --job-name RNAseq.Step1
...
singularity exec --cleanenv $SIF \
    Rscript $PWD/scriptsForRekaikEtAl2025/scRNAseq/RNAseq.Step1.Analysis.and.Merging.R
