...
#SBATCH --mem=80G
#SBATCH -o scriptsForRekaikEtAl2025/scRNAseq/RNAseq.Step2.out
#SBATCH -e scriptsForRekaikEtAl2025/scRNAseq/RNAseq.Step2.err
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --mail-user=lucille.delisle@epfl.ch
#SBATCH --job-name RNAseq.Step2
...
singularity exec --cleanenv $SIF \
    Rscript $PWD/scriptsForRekaikEtAl2025/scRNAseq/RNAseq.Step2.Clustering.Velo.R
