...
#SBATCH --mem=80G
#SBATCH -o scriptsForRekaikEtAl2025/Multiome/Multiome.Step1.out
#SBATCH -e scriptsForRekaikEtAl2025/Multiome/Multiome.Step1.err
...
singularity exec --cleanenv $SIF \
    Rscript $PWD/scriptsForRekaikEtAl2025/Multiome/Multiome.Step1.Merging.R
