...
#SBATCH --mem=80G
#SBATCH -o scriptsForRekaikEtAl2025/Multiome/Multiome.Step2.5.out
#SBATCH -e scriptsForRekaikEtAl2025/Multiome/Multiome.Step2.5.err
#SBATCH --mail-type=BEGIN,END,FAIL
#SBATCH --mail-user=lucille.delisle@epfl.ch
#SBATCH --job-name step2.5
...
singularity exec --cleanenv $SIF \
    Rscript $PWD/scriptsForRekaikEtAl2025/Multiome/Multiome.Step2.5.addMotifs.R
