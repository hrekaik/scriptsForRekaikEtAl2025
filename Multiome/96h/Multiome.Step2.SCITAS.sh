...
#SBATCH --mem=80G
#SBATCH -o scriptsForRekaikEtAl2025/Multiome/Multiome.Step2.out
#SBATCH -e scriptsForRekaikEtAl2025/Multiome/Multiome.Step2.err
...
singularity exec --cleanenv $SIF \
    Rscript $PWD/scriptsForRekaikEtAl2025/Multiome/Multiome.Step2.Velo.R
